...
# ----------------------------------------------------------------
# ROUTE 11b — Mode KPI 3 (departement ou fallback)
# ----------------------------------------------------------------
@app.get("/api/kpi3/mode")
def api_kpi3_mode():
    return JSONResponse(content={"mode": get_kpi3_mode()})


# ----------------------------------------------------------------
# ROUTE Bonus 2 — Matrice de corrélation entre variables
# ----------------------------------------------------------------
@app.get("/api/graphiques/correlation")
def api_correlation():
    return JSONResponse(content=get_correlation_matrix())
